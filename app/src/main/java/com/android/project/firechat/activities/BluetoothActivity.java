...
import com.android.project.firechat.services.BluetoothChat;
...
public class BluetoothActivity extends AppCompatActivity {
    ...
    private void showPrinterPickDialog() {
        ...
        dialog.setContentView(R.layout.activity_bluetooth_layout);
        ...
        if (pairedDevices.size() > 0) {
            ...
            pairedDevicesAdapter.add("none_paired");
        }
        ...
        switch (requestCode) {
            case REQUEST_ENABLE_BLUETOOTH:
                if (resultCode == Activity.RESULT_OK) {
                    bluetoothChat = new BluetoothChat(BluetoothActivity.this, handler);
                } else {
    ...
    private void sendMessage(String message) {
        if (bluetoothChat.getState() != BluetoothChat.STATE_CONNECTED) {
    ...
    public void onResume() {
        ...
        if (bluetoothChat != null) {
            if (bluetoothChat.getState() == BluetoothChat.STATE_NONE) {
                bluetoothChat.start();
            }
        }
    }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                ...
                if (discoveredDevicesAdapter.getCount() == 0) {
                    discoveredDevicesAdapter.add("none_found");
                }
            }
        }
    };
